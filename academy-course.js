(() => {
  ...
  const courses = {
    'lash-lifting-course': {
      name:'Lash Lifting Course', short:'Master professional lash lifting through focused theory, safe product application and guided hands-on practice.', duration:'2 Days', fee:'Rs. 20,000', image:'1. Arden_page-0001.jpg', category:'Lash artistry',
    ...
    'professional-hairstyling-course': {
      name:'Professional Hairstyling Course', short:'Build polished salon styling skills through preparation, curling, bridal styling and professional finishing techniques.', duration:'3 Days', fee:'Rs. 35,000', image:'1. Arden_page-0002.jpg', category:'Professional hairstyling', includes:benefits,
    ...
    'professional-makeup-course-5-days': {
      name:'Professional Makeup Course — 5 Days', short:'An intensive introduction to professional makeup, from considered skin preparation to bridal, glam and portfolio-ready practical work.', duration:'5 Days', fee:'Rs. 1,50,000', image:'1. Arden_page-0003.jpg', category:'Professional makeup', includes:benefits,
    ...
    'professional-makeup-course-7-days': {
      name:'Professional Makeup Course — 7 Days', short:'Advanced professional makeup training spanning signature occasion looks, practical work and final assessment.', duration:'7 Days', fee:'Rs. 1,95,000', image:'1. Arden_page-0004.jpg', category:'Advanced makeup', includes:benefits,
    ...
    'professional-bridal-makeup-course': {
      name:'Professional Bridal Makeup Course', short:'Specialised bridal education focused on lasting base work, expressive eyes and complete wedding-day application.', duration:'5 Days', fee:'Rs. 1,50,000', image:'1. Arden_page-0005.jpg', category:'Bridal makeup', includes:benefits,
    ...
    'self-makeup-course': {
      name:'Self Makeup Course', short:'Learn to create polished makeup for yourself with professional guidance tailored to your features, products and routine.', duration:'3 Days', fee:'Rs. 25,000', image:'1. Arden_page-0006.jpg', category:'Personal makeup', note:'Please bring your own makeup products and tools for the class. If required, a makeup kit may be purchased from Arden at an additional cost before training.',
    ...
    'professional-blow-dry-class': {
      name:'Professional Blow Dry Class', short:'Hands-on blow-dry training covering analysis, volume, smoothness, salon finishing and advanced styling control.', duration:'3 Days', fee:'Rs. 15,000', image:'1. Arden_page-0007.jpg', category:'Hair styling', includes:['Professional certificate','Hands-on practice','Live demonstration'],
  ...
  document.querySelector('#course-page').innerHTML = `
    ...
    <section class="course-hero">
      <div class="course-hero__copy"><p class="course-kicker">Arden Academy · ${course.category}</p><h1>${course.name}</h1><p class="course-lead">${course.short}</p><dl><div><dt>Duration</dt><dd>${course.duration}</dd></div><div><dt>Course fee</dt><dd>${course.fee}</dd></div></dl><div class="course-actions"><a class="course-button course-button--primary" href="${whatsapp}" target="_blank" rel="noopener">Enrol now <span>↗</span></a><a class="course-button" href="contact.html">Contact Academy</a></div></div>
    ...
    <section class="course-facts"><div><span>01</span><small>Duration</small><strong>${course.duration}</strong></div><div><span>02</span><small>Course fee</small><strong>${course.fee}</strong></div><div><span>03</span><small>Training type</small><strong>Instructor-led</strong></div><div><span>04</span><small>Category</small><strong>${course.category}</strong></div></section>
